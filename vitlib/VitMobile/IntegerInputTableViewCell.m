...
- (BOOL)resignFirstResponder {
    debug_NSLog(@"int cell.tag %d", self.tag);
	if (valueChanged && self.vitDelegate && [self.vitDelegate respondsToSelector:@selector(tableViewCell:didEndEditingWithInteger:)]) {
		[self.vitDelegate tableViewCell:self didEndEditingWithInteger:self.numberValue];
	}
