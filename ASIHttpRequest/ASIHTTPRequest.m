...
- (void)startRequest
{
    ...
    //
#pragma mark refer to http://stackoverflow.com/questions/8538449/asihttprequesterrordomain-code-1
    ...
    if([[[[self url] scheme] lowercaseString] isEqualToString:@"https1"]) {
...
+ (NSDate *)dateFromRFC1123String:(NSString *)string
{
	...
	[formatter setLocale:[[[NSLocale alloc] initWithLocaleIdentifier:@"zh_CN_POSIX"] autorelease]];
